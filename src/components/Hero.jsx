...
const Hero = () => {
  ...
  useEffect(()=>
  {
    init(textRef.current, { showCursor: true, strings: [' Student at PEC ', " Learner ", " Content Writer ",'Full Stack Developer ', " Tech Enthusiast "] })
  },[]);
      ...
      >
        ...
        <div className="head2">
          <h1 className={`${styles.heroHeadText} text-white`}>
            Hii there, I'm <p className='name text-[#915EFF]'>Lakshya Verma</p>
          </h1>
          <h3>
        ...
        <a
          href="https://github.com/lakshyeahh" target="_blank">
          <AiOutlineGithub />
        </a>
        <a
          href="https://www.linkedin.com/in/lakshya-verma-9b922a255/" target="_blank">
          <ImLinkedin />
        </a>
        <a
          href="https://www.instagram.com/lkshye__" target="_blank">
          <AiOutlineInstagram />
        </a>
